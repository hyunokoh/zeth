...
class AuditAddressPriv:
    ...
    def _from_json_dict(key_dict: Dict[str, Any]) -> AuditAddressPriv:
        return AuditAddressPriv(
            ownership_secret_key_from_hex(key_dict["k_sk"]),
...
class AuditAddress:
    ...
    def ownership_keypair(self) -> OwnershipKeyPair:
        return OwnershipKeyPair(self.addr_sk.k_sk, self.addr_pk.k_pk)
...
def generate_audit_address() -> AuditAddress:
    ...
    return AuditAddress.from_key_pairs(ownership_keypair, encryption_keypair)
